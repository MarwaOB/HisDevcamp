  ...
  return (
    <div className="min-h-screen bg-white ml-[200px] p-6">
      ...
      <h1 className="text-4xl font-serif text-center font-semibold mb-6">
        Flexible Plans For Every Needs
      </h1>
      ...
      <div className="flex justify-center space-x-2 mb-10">
        <button
          className={`px-4 py-1 rounded border ${
            billingType === 'monthly' ? 'bg-teal-700 text-white' : 'bg-white text-gray-700'
          }`}
        ...
        <button
          className={`px-4 py-1 rounded border ${
            billingType === 'yearly' ? 'bg-teal-700 text-white' : 'bg-white text-gray-700'
          }`}
